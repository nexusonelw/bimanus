export const SITE_NAME = "Bimanus";
export const SITE_URL = "https://www.pi-gui.com";
export const OG_IMAGE_PATH = "/og.png";
export const OG_IMAGE_ALT = "Bimanus desktop app preview";
export const OG_IMAGE_WIDTH = 1480;
export const OG_IMAGE_HEIGHT = 980;

export const SITE_TITLE = "Bimanus — A native desktop for AI coding agents";
export const SITE_DESCRIPTION =
  "Bimanus is a beta macOS and Linux desktop app for the pi coding agent. Install it from GitHub Releases, manage multiple workspaces, and keep persistent agent session history in a native desktop shell.";
