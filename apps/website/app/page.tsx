...
const GITHUB_URL = "https://github.com/nexusonelw/bimanus";
const RELEASES_URL = "https://github.com/nexusonelw/bimanus/releases/latest";
    ...
    <>
      ...
      <nav className="nav">
        <div className="nav-inner">
          <span className="nav-logo">Bimanus</span>
      ...
      <main>
        ...
        <section className="hero">
          <div className="container">
            ...
            <p className="hero-subtitle">
              Bimanus is a Codex-style macOS and Linux desktop app for the{" "}
              <a
                href={PI_MONO_URL}
                target="_blank"
                rel="noopener noreferrer"
        ...
        <section className="value-prop">
          <div className="container container--narrow">
            <p>
              From quick fixes to complex refactors, Bimanus gives you a
          ...
          <div className="container">
            ...
            <div className="features-grid">
              ...
              <div className="feature-card">
                ...
                <p>
                  Extend Bimanus with workspace-specific skills and slash
        ...
        <section id="get-started" className="get-started">
          <div className="container">
            ...
            <p className="section-subtitle">
              ...
              with <code>brew upgrade --cask bimanus</code>. During beta,
