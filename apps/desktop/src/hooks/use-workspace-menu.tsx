...
export interface WorkspaceMenuState {
  ...
  readonly expandedSessionListByWorkspace: Record<string, boolean>;
  ...
  readonly toggleExpandedSessionList: (workspaceId: string) => void;
...
export function useWorkspaceMenu(params: UseWorkspaceMenuParams): WorkspaceMenuState {
  ...
  const [expandedSessionListByWorkspace, setExpandedSessionListByWorkspace] = useState<Record<string, boolean>>({});
  ...
  const toggleExpandedSessionList = (workspaceId: string) => {
    setExpandedSessionListByWorkspace((current) => ({ ...current, [workspaceId]: !current[workspaceId] }));
  };
  ...
  return {
    ...
    collapsedWorkspaces,
    expandedSessionListByWorkspace,
    environmentMenuOpen,
