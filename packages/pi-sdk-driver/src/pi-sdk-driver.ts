...
import type { SessionCatalogSnapshot, WorkspaceCatalogSnapshot, WorkspaceId } from "@bimanus/catalogs";
import type {
...
export class PiSdkDriver implements SessionDriver {
  ...
  getSessionSnapshot(sessionRef: SessionRef): Promise<SessionSnapshot> {
    return this.supervisor.getSessionSnapshot(sessionRef);
  }
  ...
  reopenSessionFromDisk(sessionRef: SessionRef): Promise<void> {
    return this.supervisor.reopenSessionFromDisk(sessionRef);
  }
